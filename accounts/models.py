...
class CustomerReg(AbstractBaseUser):
    ...
    # employment_status = models.ForeignKey(EmploymentStatus, on_delete=models.CASCADE, default=1, null=True)
    ...
    REQUIRED_FIELDS = ['firstname', 'lastname', 'date_sent','phone_number', 'work_address', 'salary', ]
